...
use App\Repository\VolunteerInfoRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\HttpFoundation\File\File;
use Vich\UploaderBundle\Mapping\Annotation as Vich;

#[ORM\Entity(repositoryClass: VolunteerInfoRepository::class)]
#[Vich\Uploadable]
class VolunteerInfo
{
    #[ORM\Id]
    ...
    #[ORM\OneToOne(mappedBy: 'volunteerInfo', cascade: ['persist', 'remove'])]
